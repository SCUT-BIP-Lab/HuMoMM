...
class Graph:
    ...
    def __init__(self,
        ...
        assert layout in [
            'openpose-18', 'openpose-25', 'ntu-rgb+d', 'scut', 'ntu_edge', 'coco'
        ]
    ...
    def get_edge(self, layout):
        ...
        if layout == 'openpose-18':
            ...
            self.num_node = 21
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_1base = [(0,1), (1, 2), (2,3), (3,4), (2,5), (2,9), (5,6), (9,10),
                              (6,7), (10,11), (7,8), (11,12), (0,17), (0,13), (17,18),
                              (13,14), (18,19), (14,15), (19,20), (15,16),]
            neighbor_link = [(i - 1, j - 1) for (i, j) in neighbor_1base]
            self.self_link = self_link
            self.neighbor_link = neighbor_link
            self.edge = self_link + neighbor_link
