...
from .scut_3dhp import SCUT_3DHP
from .scut_3dhp_mp import SCUT_3DHP_MP
dataset_dict = {'h36m': H36M, 'mpii': MPII, 'coco': COCO14, 'posetrack':Posetrack21, 'aich':AICH, 'pw3d':PW3D, 'up':UP, 'crowdpose':Crowdpose, 'crowdhuman':CrowdHuman, \
    ...
    'cmup':CMU_Panoptic_eval,'internet':Internet, 'relative_human': Relative_human, 'agora':AGORA, 'scut_sp': SCUT_3DHP, 'scut_mp': SCUT_3DHP_MP}
