...
SCUT_21 = {
    "Pelvis": 0, "Spine": 1, "Neck": 2, "Jaw": 3, "Head": 4, "L_Shoulder": 5, "L_Elbow": 6, "L_Wrist": 7,
    "L_Hand": 8, "R_Shoulder": 9, "R_Elbow": 10, "R_Wrist ": 11, "R_Hand": 12, "L_Hip": 13,
    "L_Knee": 14, "L_Ankle": 15, "L_Toe_SMPL": 16, "R_Hip": 17, "R_Knee": 18, "R_Ankle": 19, "R_Toe_SMPL": 20
    }
...
dataset_involved = ['h36m', 'mupots', 'pw3d', 'mpiinf', 'jta','cmup', 'oh','mpiinf_test', 'pw3d_pc', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'pw3d_normal','agora','mini','pw3d_od', 'scut_sp', 'scut_mp']
dataset_kp2ds = ['h36m', 'mupots', 'pw3d', 'mpiinf', 'jta','cmup', 'oh','mpiinf_test', 'pw3d_pc', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'pw3d_normal','agora','mini','relativity', 'aich', 'crowdpose','pw3d_od', 'scut_sp', 'scut_mp']
dataset_smpl2lsp = ['h36m', 'cmup','mpiinf','mpiinf_test', 'jta', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'scut_sp', 'scut_mp'] #'pw3d', 
MPJAE_ds = ['pw3d_normal', 'h36m', 'scut_sp', 'scut_mp']
PVE_ds = ['pw3d_pc', 'pw3d_nc','pw3d_oc','pw3d_vibe', 'pw3d_normal', 'oh','agora','mini', 'scut_sp', 'scut_mp']
