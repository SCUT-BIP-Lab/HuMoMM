...
class Base(object):
    ...
    def set_up_val_loader(self):
        ...
        if 'scut_sp' in eval_datasets:
            self.dataset_val_list['scut_sp'] = self._create_single_data_loader(dataset='scut_sp', train_flag=False,split='val')
            self.dataset_test_list['scut_sp'] = self._create_single_data_loader(dataset='scut_sp', train_flag=False,split='test')
        if 'scut_mp' in eval_datasets:
            self.dataset_val_list['scut_mp'] = self._create_single_data_loader(dataset='scut_mp', train_flag=False,split='val')
            self.dataset_test_list['scut_mp'] = self._create_single_data_loader(dataset='scut_mp', train_flag=False,split='test')
