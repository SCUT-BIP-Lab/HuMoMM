...
def gen_coco_style_json(data_path, out_path, benchmark='xsub'):
    val_annotations = {}
    ...
    with open('{}/train_label_{}.json'.format(out_path,benchmark), 'w') as f:
...
if __name__ == '__main__':
    ...
    gen_coco_style_json(skeleton_dir, out_dir, benchmark)
