...
def summary(log, model, input_size, batch_size=-1, device="cuda"):
    ...
    # log.info(x.shape)
    y = model(*x)
    ouput_shape = list(y.shape)
    ouput_shape[0] = batch_size
    ...
    log.info("----------------------------------------------------------------")
    log.info("{:>20}  {:>25}".format(
        "Output Shape", str(ouput_shape)))
    log.info("================================================================")
