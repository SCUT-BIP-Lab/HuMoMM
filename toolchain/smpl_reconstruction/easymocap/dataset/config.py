...
CONFIG['body21'] = {'nJoints': 21, 'kintree':
   [[ 1,  0],
    [ 2,  1],
    [ 3,  2],
    [ 4,  3],
    ...
    [19, 18],
    [20, 19]], 
    'joint_names': ["hip", "spine", "neck", "chin", "head", "left shoulder", "left elbow", "left wrist",
...
CONFIG['body21']['colors'] = ['k', 'r', 'r', 'r', 'b', 'b', 'b', 'k', 'r', 'r', 'r', 'b', 'b', 'b', 'r', 'b', 'r', 'b', 'b', 'b']
# CONFIG['body21']['skeleton'] = \
# {
#    ( 0, 1): {'mean': 0.228, 'std': 0.046}, # Nose     ->Neck     
#    ( 1, 2): {'mean': 0.144, 'std': 0.029}, # Neck     ->RShoulder
#    ( 2, 3): {'mean': 0.283, 'std': 0.057}, # RShoulder->RElbow   
#    ( 3, 4): {'mean': 0.258, 'std': 0.052}, # RElbow   ->RWrist   
#    ( 2, 5): {'mean': 0.145, 'std': 0.029}, # Neck     ->LShoulder
#    ( 5, 6): {'mean': 0.281, 'std': 0.056}, # LShoulder->LElbow   
#    ( 6, 7): {'mean': 0.258, 'std': 0.052}, # LElbow   ->LWrist   
#    ( 7, 8): {'mean': 0.483, 'std': 0.097}, # Neck     ->MidHip   
#    ( 2, 9): {'mean': 0.106, 'std': 0.021}, # MidHip   ->RHip     
#    ( 9,10): {'mean': 0.438, 'std': 0.088}, # RHip     ->RKnee    
#    (10,11): {'mean': 0.406, 'std': 0.081}, # RKnee    ->RAnkle   
#    (11,12): {'mean': 0.106, 'std': 0.021}, # MidHip   ->LHip     
#    ( 0,13): {'mean': 0.438, 'std': 0.088}, # LHip     ->LKnee    
#    (13,14): {'mean': 0.408, 'std': 0.082}, # LKnee    ->LAnkle   
#    (14,15): {'mean': 0.043, 'std': 0.009}, # Nose     ->REye     
#    (15,16): {'mean': 0.043, 'std': 0.009}, # Nose     ->LEye     
#    ( 0,17): {'mean': 0.105, 'std': 0.021}, # REye     ->REar     
#    (17,18): {'mean': 0.104, 'std': 0.021}, # LEye     ->LEar     
#    (18,19): {'mean': 0.180, 'std': 0.036}, # LAnkle   ->LBigToe  
#    (19,20): {'mean': 0.038, 'std': 0.008}, # LBigToe  ->LSmallToe
# }
