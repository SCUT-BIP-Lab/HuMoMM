...
def read_annot(annotname, mode='body25'):
    ...
    for i in range(len(data)):
        ...
        if mode == 'body25':
            ...
            data[i]['keypoints'] = data[i].get('keypoints', np.zeros((24, 3)))
        elif mode == 'body21':
            data[i]['keypoints'] = data[i].get('keypoints', np.zeros((21, 3)))
        elif mode == 'body15':
...
def write_common_results(dumpname=None, results=[], keys=[], fmt='%2.9f'):
