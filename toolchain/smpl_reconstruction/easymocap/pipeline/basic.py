...
'''
from easymocap.pyfitting.optimize_simple import optimizePose2DCam
...
def multi_stage_optimize(body_model, params, kp3ds, kp2ds=None, bboxes=None, Pall=None, weight={}, cfg=None, dataset=None):
    ...
    if kp2ds is not None:
        with Timer('Optimize 2D Pose/{} frames'.format(kp3ds.shape[0])):
            ...
            if not cfg.opt_cam:
                ...
                params = optimizePose2DCam(body_model, params, bboxes, kp2ds, Pall, weight=weight, cfg=cfg, dataset=dataset)
    return params
...
def smpl_from_keypoints3d2d(body_model, kp3ds, kp2ds, bboxes, Pall, config, args,
    weight_shape=None, weight_pose=None, dataset=None): # dataset to optimize cam params 
    ...
    params = multi_stage_optimize(body_model, params, kp3ds, kp2ds, bboxes, Pall, weight_pose, cfg, dataset)
